...
import { Search, Upload, Filter, RefreshCw } from "lucide-react";
...
const DocumentsPage: React.FC = () => {
  ...
  const [documents, setDocuments] = useState<Array<{ipfsHash: string; name: string; size: number; createdAt: string;}>>([]);
  const [filteredDocuments, setFilteredDocuments] = useState<Array<{ipfsHash: string; name: string; size: number; createdAt: string;}>>([]);
